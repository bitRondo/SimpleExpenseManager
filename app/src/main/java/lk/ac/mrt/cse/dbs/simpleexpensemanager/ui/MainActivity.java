...
import lk.ac.mrt.cse.dbs.simpleexpensemanager.control.StorageExpenseManager;
import lk.ac.mrt.cse.dbs.simpleexpensemanager.data.storageImpl.DatabaseHelper;

public class MainActivity extends AppCompatActivity {
    private ExpenseManager expenseManager, storageExpenseManager;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expenseManager = new StorageExpenseManager(dbHelper);
        /*** END ***/
    }
